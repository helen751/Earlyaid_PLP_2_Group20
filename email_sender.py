...
class EmailSender():
    def __init__(self):
        ...
        self.coloredMessage.print("Sending email, please wait...", "green")

    def send_email_to_parent(self, parent_email, child_name, risk_level, suggestion, short_topic, doctor_details = None):
        """
